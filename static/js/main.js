...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    tinymce.init({
        ...
        height: 200,
        menubar: false,
        plugins: 'autosave lists link image charmap preview anchor searchreplace visualblocks code fullscreen insertdatetime media table help wordcount autolink',
